...
- **🚪 Grand Library Aisle Landing Page & Auth Gate**: Immersive 3D perspective corridor looking down a majestic library aisle flanked by towering bookshelves and warm amber sconces; requires login to provision a pristine, empty personal library (0 pre-populated mock books).
